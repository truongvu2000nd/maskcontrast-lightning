...
class Resize(object):
    def __init__(self, size):
        ...
        self.resize_img = torchvision.transforms.Resize(self.size, interpolation=T.InterpolationMode.BILINEAR)
        self.resize_sal = torchvision.transforms.Resize(self.size, interpolation=T.InterpolationMode.NEAREST)
